...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    objetoRetornado = createMenu({ pizza: {}, refrigerante: {} });
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), { pizza: {}, refrigerante: {} });
    ...
    const obj = { food: { coxinha: 3.90, sanduiche: 9.90 }, drinks: { agua: 3.90, cerveja: 6.90 } };
