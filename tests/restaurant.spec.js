...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const keys = Object.keys(meuRestaurante.fetchMenu());
    ...
    const meuRestaurante2 = createMenu(obj);
    ...
    const meuRestaurante3 = createMenu(obj);
    ...
    const meuRestaurante4 = createMenu(obj);
    meuRestaurante4.order('coxinha');
    meuRestaurante4.order('agua');
    meuRestaurante4.order('coxinha');
    assert.strictEqual(meuRestaurante4.pay(), 11.7);
    // ```
