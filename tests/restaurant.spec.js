...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    objetoRetornado = createMenu(objeto);
    ...
    // ```
    let objetoRetornado1 = createMenu(objeto);
    ...
    // ```
    let objetoRetornado2 = createMenu(objeto);
    objetoRetornado2.order('coxinha');
    objetoRetornado2.order('agua');
    objetoRetornado2.order('coxinha');
    // objetoRetornado.pay() // Retorno: somaDosPreçosDosPedidos
    // ```
    assert.deepStrictEqual(objetoRetornado2.pay(), 11.70);
