...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    // ```
    abstractObject = { food: {}, drink: {} };
    expected = ['food', 'drink'];
    assert.deepStrictEqual(Object.keys(createMenu(abstractObject).fetchMenu()), expected);
    ...
    // ```
    abstractObject = { food: { coxinha: 3.9 }, drink: { agua: 3.9 } };
    assert.deepStrictEqual(createMenu(abstractObject).fetchMenu(), abstractObject);
    ...
    // ```
    let testObject = createMenu(abstractObject);
    assert.deepStrictEqual((testObject.consumption), []);
    ...
    expected = ['coxinha'];
    assert.deepStrictEqual((testObject.consumption), expected);
    ...
    // ```
    testObject = createMenu(abstractObject);
    addOrders(['coxinha', 'agua', 'sopa', 'sashimi'], testObject);
    ...
    // ```
    testObject = createMenu(abstractObject);
    addOrders(['coxinha', 'agua', 'coxinha'], testObject);
    ...
    // ```
    expected = 12.87;
    assert.strictEqual((testObject.pay()), expected);
