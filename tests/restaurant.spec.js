...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    ...
    const retornoFetchMenu = { food: { coxinha: 3.9, sopa: 9.9 },
      drink: { agua: 3.9, cerveja: 6.9 } };
    assert.deepStrictEqual(retornoFetchMenu, createMenu(retornoFetchMenu).fetchMenu());
    ...
    // ```
    objetoRetornado = createMenu(retornoFetchMenu);
    objetoRetornado.consumption = [];
    objetoRetornado.order('coxinha');
    objetoRetornado.order('agua');
    objetoRetornado.order('coxinha');
